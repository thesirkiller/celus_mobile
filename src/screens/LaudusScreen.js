...
export default function LaudusScreen({ navigation }) {
  ...
  // Especialidades de laudos no app anterior
  const categories = ['Todos', 'Ginecologia', 'Obstetrícia', 'Medicina Interna', 'Emergência POCUS', 'Cervical'];
  ...
  /**
   * Busca os laudos do Supabase com estratégia offline-first
   */
  const fetchData = async () => {
    ...
    try {
      ...
      console.log('Erro ao carregar dados do Laudus:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  /**
   * Filtra os laudos com base na pesquisa e na categoria
   */
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>LaudUS</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {loading && data.length === 0 ? (
        <View style={styles.loaderContainer}>
          ...
          <Text style={styles.loaderText}>Carregando modelos de laudo...</Text>
        </View>
      ) : (
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Nenhum laudo encontrado para os filtros selecionados.</Text>
            </View>
          }
        />
      )}
